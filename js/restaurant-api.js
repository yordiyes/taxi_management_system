        ...
        <div class="card service-card">
          ...
          <div class="card-content">
            ...
            <p class="card-description">
              <span class="location-icon">Ì≥ç</span> ${restaurant.address}
            </p>
            <div class="features-list mb-4">
              <span class="feature-item">‚≠ê ${restaurant.rating} (${restaurant.review_count} reviews)</span>
              <span class="feature-item">Ì≤∞ ${restaurant.price_range}</span>
            </div>
